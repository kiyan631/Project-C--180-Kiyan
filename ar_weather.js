...
function get_weather(){
    $.ajax({
        url:'https://api.openweathermap.org/data/2.5/weather?lat=${coordinates.destination_lat}&lon={coordinates.destination_lon}&appid=772fcd6000f53d54fb00932d30321a4f',
        type:"get",
